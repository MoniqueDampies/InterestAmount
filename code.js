...
function simpleInterest() {
  ...
  var interestRate = parseFloat(
    document.getElementById("interestSimple").value
  );
  ...
  document.getElementById("siOutput-01").innerHTML =
    "Interest: R" + simpleInt.toFixed(2);
  document.getElementById("siOutput-02").innerHTML =
    "Total plus interest: R" + amount;
}
function compoundInterest() {
  event.preventDefault();
  var principal = parseFloat(
    document.getElementById("principalCompound").value
  );
  var interestRate = parseFloat(
    document.getElementById("interestCompound").value
  );
  interestRate = interestRate / 100;
  var timesCompounded = parseFloat(
  ...
  document.getElementById("ciOutput-01").innerHTML =
    "Interest: R" + (amount - principal).toFixed(2);
  document.getElementById("ciOutput-02").innerHTML =
    "Total plus interest: R" + amount;
}
